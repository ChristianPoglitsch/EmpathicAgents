...
def reflect(scratch: Union[PersonaScratch, UserScratch], a_mem: AssociativeMemory):
...
def run_reflect(scratch:Union[PersonaScratch, UserScratch], a_mem:AssociativeMemory):
