...
def lets_talk(init_scratch:PersonaScratch, 
  ...
  if generate_decide_to_talk(init_scratch, init_amem, target_scratch, retrieved, model): 
    return True
  return False
...
def generate_decide_to_talk(init_scratch:PersonaScratch, 
                            ...
                            model:LLM_API): 
  x = run_prompt_decide_to_talk(init_scratch, init_amem, target_scratch, retrieved, model)[0]
  return x == "yes" 
...
def lets_react(init_scratch, target_scratch, retrieved, model): 
  ...
  react_mode = generate_decide_to_react(init_scratch, target_scratch, retrieved, model)
