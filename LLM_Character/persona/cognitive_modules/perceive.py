...
def perceive(cscratch: PersonaScratch,
  ...
  for p_event in perceived_events: 
    ...
    if p_event not in latest_events:
      ...
      # NOTE: different poig score for thoughts, convo and events? or same function?  
      ...
      # in the first place, why chats included in events ??? events dont need associated chats?? idk
      ...
      ret_events += [camem.add_event(cscratch.curr_time, None,
...
if __name__ == "__main__":
  ...
  person.load_from_file(BASE_DIR + "/LLM_Character/storage/localhost/default/personas/Florian")
  user = User("Louis")
  ...
  events = perceive(person.scratch, person.a_mem, person.s_mem, location_data, perceived_events, model)