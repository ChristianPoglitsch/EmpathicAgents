...
def _create_prompt_input(init_scratch:PersonaScratch, 
    ...
    if len(init_scratch.planned_path) == 0: 
      ...
      if ":" in init_scratch.act_address:
        loc = init_scratch.act_address.split(":")[-1] + " in " + init_scratch.act_address.split(":")[-2]
    ...
    if len(target_scratch.planned_path) == 0: 
      ...
      if ":" in target_scratch.act_address:
        loc = target_scratch.act_address.split(":")[-1] + " in " + target_scratch.act_address.split(":")[-2]
...
def run_prompt_decide_to_react(init_scratch:PersonaScratch, 
                              ...
                              model:LLM_API, 
                              verbose=False):
    prompt_template = BASE_DIR + "/LLM_Character/persona/prompt_modules/templates/decide_to_react.txt" 
