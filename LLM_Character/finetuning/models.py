...
def load_pipeline(model:PreTrainedModel, tokenizer:PreTrainedTokenizer, max_length:int):
    return pipeline("text-generation", model=model, tokenizer=tokenizer, max_new_tokens=max_length)
...
def generate_text(prompt:str, model:PreTrainedModel, tokenizer:PreTrainedTokenizer, generation_config:GenerationConfig, max_num_token:int):
